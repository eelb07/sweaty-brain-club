...
| 문제 번호 | 문제 이름 | 난이도 | 풀이 링크 | ⭐ | 💬 |
|:---:|:---:|:---:|:---:|:---:|:---:|
| [32680](https://www.acmicpc.net/problem/32680) |  두 스택 | Silver 3 | [Seunga](./src/brute-force/BOJ-32680-S.md) |  |  |
...
| [42842](https://school.programmers.co.kr/learn/courses/30/lessons/42842) | 카펫  | level 2 | [Seunga](./src/brute-force/Programmers-카펫-S.md) |  |  |
...
|               문제               |  난이도  |  ⭐  |  ✅ |
| :----------------------------: | :-----: | :-: | :-: |
| [잡은 물고기 중 가장 큰 물고기의 길이 구하기](./src/sql/298515. 잡은 물고기 중 가장 큰 물고기의 길이 구하기) | Lv. 1 ||✅ CONCAT |  
| [즐겨찾기가 가장 많은 식당 정보 출력하기](./src/sql/131123. 즐겨찾기가 가장 많은 식당 정보 출력하기) | Lv. 3 |⭐⭐⭐|✅ ROW_NUMBER() OVER |  
| [물고기 종류 별 대어 찾기](./src/sql/293261. 물고기 종류 별 대어 찾기) | Lv. 3 |⭐⭐⭐|✅ ROW_NUMBER() OVER |
| [대장균의 크기에 따라 분류하기 2](./src/sql/301649. 대장균의 크기에 따라 분류하기 2) | Lv. 3 |⭐⭐⭐|✅ NTILE() OVER |  
| [보호에서 중성화한 동물](./src/sql/59045. 보호소에서 중성화한 동물) | Lv. 4 | |✅ |  
|     [식품분류별 가장 비싼 식품의 정보 조회하기](./src/sql/131116. 식품분류별 가장 비싼 식품의 정보 조회하기)    | Lv. 4 |  ⭐   |  ✅ CTE, 윈도우 함수   |
|        [5월 식품들의 총매출 조회하기](./src/sql/131117. 5월 식품들의 총매출 조회하기)        | Lv. 4 |   ⭐  |  ✅ CTE   |
|       [취소되지 않은 진료 예약 조회하기 ](./src/sql/132204. 취소되지 않은 진료 예약 조회하기)      | Lv. 4 |     |  ✅ table 3개 조인   |
|      [저자 별 카테고리 별 매출액 집계하기](./src/sql/144856. 저자 별 카테고리 별 매출액 집계하기)      | Lv. 4 |     |  ✅  |
|    [년, 월, 성별 별 상품 구매 회원 수 구하기](./src/sql/131532. 년， 월， 성별 별 상품 구매 회원 수 구하기)   | Lv. 4 |     |  ✅ YEAR, MONTH, DISTINCT   |
|       [서울에 위치한 식당 목록 출력하기 ](./src/sql/131118. 서울에 위치한 식당 목록 출력하기)      | Lv. 4 |     |  ✅   |
|        [우유와 요거트가 담긴 장바구니](./src/sql/62284. 우유와 요거트가 담긴 장바구니)        | Lv. 4 |     |  ✅ HAVING   |
|       [주문량이 많은 아이스크림을 조회하기](./src/sql/133027. 주문량이 많은 아이스크림들 조회하기)      | Lv. 4 |     |  ✅ UNION ALL   |
| [연간 평가점수에 해당하는 평가 등급 및 성과금 조회하기](./src/sql/284528. 연간 평가점수에 해당하는 평가 등급 및 성과금 조회하기) | Lv. 4 |     |  ✅ CASE   |
|      [그룹별 조건에 맞는 식당 목록 출력하기](./src/sql/131124. 그룹별 조건에 맞는 식당 목록 출력하기)     | Lv. 4 |   ⭐  |  ✅ CTE, DATE_FORMAT |
|      [오프라인/온라인 판매 데이터 통합하기](./src/sql/131537. 오프라인／온라인 판매 데이터 통합하기)      | Lv. 4 |     |  ✅ UNION ALL + NULL AS   |
|          [입양 시각 구하기(2)](./src/sql/59413. 입양 시각 구하기（2）)          | Lv. 4 | ⭐⭐⭐  |  ✅ RECURSIVE CTE, LEFT JOIN, IFNULL   |
|         [ 특정 세대의 대장균 찾기](./src/sql/301650. 특정 세대의 대장균 찾기)         | Lv. 4 |   ⭐⭐  |  ✅ 계층형, RECURSIVE CTE   |
|      [자동차 대여 기록 별 대여 금액 구하기](./src/sql/151141. 자동차 대여 기록 별 대여 금액 구하기)     | Lv. 4 |     |  ✅ IFNULL, CTE |
|         [FrontEnd 개발자 찾기](./src/sql/276035. FrontEnd 개발자 찾기)        | Lv. 4 |     |  ✅ 비트마스킹   |
|  [특정 기간동안 대여 가능한 자동차들의 대여비용 구하기](./src/sql/157339. 특정 기간동안 대여 가능한 자동차들의 대여비용 구하기) | Lv. 4 |     |   ✅ WHERE NOT    |
|        [상품을 구매한 회원 비율 구하기 ](./src/sql/131534. 상품을 구매한 회원 비율 구하기)      | Lv. 5 |     |  ✅   |
|          [언어별 개발자 분류하기](./src/sql/276036. 언어별 개발자 분류하기)          | Lv. 4 |     |  ✅ CASE 여러개, 비트마스킹   |
|          [멸종위기의 대장균 찾기 ](./src/sql/301651. 멸종위기의 대장균 찾기)         | Lv. 5 |  🔥   |  ✅  RECURSIVE CTE, CTE |
